...
import { Navbar, NavbarBrand,Nav,NavbarToggler,Collapse,NavItem, Modal, ModalBody, ModalHeader, Button, Form,Label, FormGroup,Input} from 'reactstrap';
            ...
            <React.Fragment>
                <Navbar dark ="md">
                    <div className="container">
                        ...
                        <NavbarBrand className="auto" href="/">
                            ...
                            <Nav Navbar>
                                ...
                                <NavItem>
                                    <NavLink className="nav-link" to="/aboutus">
                                        <span className="fa fa-infd fa-lg"></span> About Us
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                    ...
                    <div className="container">
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                <h1 class="display-2">Restaurant</h1>
